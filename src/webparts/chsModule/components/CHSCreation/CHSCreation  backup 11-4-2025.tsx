  ...
  public render(): React.ReactElement<IChsModuleProps> {
    ...
    return (
      <div className={styles.pettyCash} >
        <div className="container" style={{border:'1px solid #ddd',  borderRadius:'4px'}}>
          <div className={styles.row}>
            <div className={styles.column}>
              <span className={styles.title}> </span>
              <div className='mb-2 text-right'><DefaultButton className='btn-primary' onClick={() => this.CreateRequest()}> <Icon iconName='CheckMark' ></Icon> Create Request</DefaultButton></div>
              <Pivot linkSize={PivotLinkSize.large} linkFormat={PivotLinkFormat.tabs} >
                  ...
                  <div className='row'>
                    ...
                    <div className={styles.tabnav + " col-md-2"}>
                        <button
                          ...
                          id="defaultOpen"
                          onClick={() => this.openPage("Pending", this, "red")}
                        >
                          Pending
                        </button>
                        ...
                        <button
                          ...
                          onClick={() => this.openPage("Approved", this, "green")}
                        >
                          Approved
                        </button>
                        ...
                        <button
                          ...
                          onClick={() => this.openPage("Rejected", this, "blue")}
                        >
                          Rejected
                        </button>
                      </div>
                ...
                <PivotItem linkText='HR1 Approver Dashboard' hidden={!this.state.ShowHR1Tab} >
                ...
                <PivotItem linkText='HR2 Approver Dashboard' hidden={!this.state.ShowHR2Tab}>
                  <div className='row'  >
                    <div className={styles.tabnav + " " + 'col-md-2'}>
                      <button className="tablink" id="defaultOpen" onClick={() => this.openPage("Pending", this, "red")}>
                        Pending
