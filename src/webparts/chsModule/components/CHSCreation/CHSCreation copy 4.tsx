...
const activeTab = savedTabId
  ? document.getElementById(savedTabId)
          ...
          <div className={styles.row}>
            <div className={styles.column}>
              ...
              <Pivot linkSize={PivotLinkSize.large} linkFormat={PivotLinkFormat.tabs} >
                <PivotItem linkText='User Dashboard' className='tab-box'>
                  <div className='row'>
                    {/* <div className={styles.tabnav + " " + 'col-md-2'} CheckMark>
                      <button className="tablink" id="defaultOpen" onClick={() => this.openPage("Pending", this, "red")}>
                        Pending
                      </button>
                      <button className="tablink" onClick={() => this.openPage("Approved", this, "green")} >
                        Approved
                      </button>
                      <button className="tablink" onClick={() => this.openPage("Rejected", this, "blue")}>
                        Rejected
                      </button>
                    </div> */}
                    <div className={styles.tabnav + " col-md-2"}>
                    <button
                            className={`tablink active ${this.state.activeTab === "Pending" ? "active" : ""}`}
                            id="defaultOpen"
                            onClick={(event) => this.openPage("Pending", event, "red", "Pending")}
                          >
                            Pending
                          </button>

                        <button
                          className={`tablink ${this.state.activeTab === 'Approved' ? 'active' : ''}`}
                          onClick={(event) => this.openPage("Approved", event, "green", "Approved")}
                        >
                          Approved
                        </button>

                        <button
                          className={`tablink ${this.state.activeTab === 'Rejected' ? 'active' : ''}`}
                          onClick={(event) => this.openPage("Rejected", event, "blue", "Rejected")}
                        >
                          Rejected
                        </button>
                      </div>
                          ...
                          <table className="table ">
                            ...
                            </tr>
                            {
                              this.state.UserDashboard.length > 0 ? this.state.UserDashboard.map((items) => {
                                return (
                                  <tr>
                                    <td><Icon iconName='View' onClick={() => this.getHR1ApproverView(items)} title='View'></Icon></td>
                                    <td>{items.Title}</td>
                ...
                <PivotItem linkText='HR1 Approver Dashboard' hidden={!this.state.ShowHR1Tab} className='tab-box'>
                  <div className='row' hidden={!this.state.ShowHR1Tab}>
                  <div className={styles.tabnav + " col-md-2"}>
                    <button
                            className={`tablink active ${this.state.activeTab === "Pending" ? "active" : ""}`}
                            id="defaultOpen"
                    ...
                    {/* <div className={styles.tabnav + " " + 'col-md-2'}>
                      <button className="tablink" id="defaultOpen" onClick={() => this.openPage("Pending", this, "red", "Pending")}>
                        Pending1
                      </button>
                      <button className="tablink" onClick={() => this.openPage("Approved", this, "green", "Approved")} >
                        Approved
                      </button>
                      <button className="tablink" onClick={() => this.openPage("Rejected", this, "blue", "Rejected")}>
                        Rejected
                      </button>
                    </div> */}
                    <div className='col-md-10'>
                ...
                <PivotItem linkText='HR2 Approver Dashboard' hidden={!this.state.ShowHR2Tab} className='tab-box'>
                  <div className='row'  >
                    <div className={styles.tabnav + " " + 'col-md-2'}>
                      <button className="tablink" id="defaultOpen" onClick={() => this.openPage("Pending", this, "red" ,"Pending")}>
                        Pending
                        ...
                        <div id="Pending" className="tabcontent active table-responsive">
                          ...
                          <div className="col-md-3">
                            ...
                            <Dropdown 
                              ...
                              className="dropdown-style form-control"
                            />
                          ...
                          <table className="table ">
                            ...
                            </tr>
                            {
                              this.state.HR2ApprPendingDashboard.length > 0 ? this.state.HR2ApprPendingDashboard.map((items) => {
                                return (
                                  <tr>
                                    <td><Icon iconName='View' onClick={() => this.getHR2ApproverView(items)} title='View'></Icon></td>
